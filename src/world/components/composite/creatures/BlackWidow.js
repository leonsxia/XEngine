...
const BLACK_WIDOW_TYPES_MAPPING = {
    STANDARD: new CreatureTypeMapping({
        ...
        idleBoundingFaceSize: { width: .68, depth: 1.5, height: .75, bbfThickness: .18, gap: .1 },
        ...
        idleBoundingBoxSize: { width: .68, depth: 1.5, height: .75 },
        walkBoundingBoxSize: { width: .68, depth: 1.5, height: .75 },
        attackBoundingBoxSize: { width: .68, depth: 1.5, height: .75 },
    ...
    DESCENDANT: new CreatureTypeMapping({
        ...
        idleBoundingFaceSize: { width: .39, depth: .8, height: .75, bbfThickness: .18, gap: .1 },
        ...
        idleBoundingBoxSize: { width: .39, depth: .8, height: .75 },
        walkBoundingBoxSize: { width: .39, depth: .8, height: .75 },
        attackBoundingBoxSize: { width: .39, depth: .8, height: .75 },
